...
[参与贡献](https://github.com/ityouknow/awesome-spring-boot/issues/1) ⭐ 4,555 | 🐛 17 | 📅 2024-05-25
...
* [mall-SpringBoot+MyBatis 电商系统](https://github.com/macrozheng/mall) ⭐ 84,701 | 🐛 19 | 🌐 Java | 📅 2026-05-14
* [Spring Boot 官方示例](https://github.com/spring-projects/spring-boot/tree/master/spring-boot-samples) ⭐ 81,400 | 🐛 488 | 🌐 Java | 📅 2026-09-02
* [纯洁的微笑 Spring Boot 示例](https://github.com/ityouknow/spring-boot-examples) ⭐ 30,498 | 🐛 17 | 🌐 Java | 📅 2023-11-18
* [Vue+SpringBoot实现的人力资源管理系统](https://github.com/lenve/vhr) ⭐ 28,075 | 🐛 216 | 🌐 Java | 📅 2024-11-25
* [Spring Boot后端 + Vue管理员前端 + 微信小程序用户前端](https://github.com/linlinjava/litemall) ⭐ 20,347 | 🐛 54 | 🌐 Java | 📅 2026-08-20
...
* [hsweb企业后台管理系统基础框架](https://github.com/hs-web/hsweb-framework) ⭐ 8,399 | 🐛 9 | 🌐 Java | 📅 2026-08-12
...
* [Docker+SpringBoot+Mybatis+thymeleaf等技术实现的Java博客系统](https://github.com/ZHENFENG13/My-Blog) ⭐ 3,892 | 🐛 25 | 🌐 Java | 📅 2024-03-07
...
* [JApiDocs：无需注解的 SpringBoot API文档生成工具](https://github.com/YeDaxia/JApiDocs) ⭐ 1,694 | 🐛 37 | 🌐 Java | 📅 2026-03-19
...
* [halo-基于SpringBoot的博客系统](https://github.com/ruibaby/halo) ⭐ 93 | 🐛 1 | 🌐 Java | 📅 2026-09-03
...
* [开源书籍-微服务：从设计到部署](https://github.com/oopsguy/microservices-from-design-to-deployment-chinese) ⭐ 5,168 | 🐛 2 | 📅 2019-07-18

## 其它

* [Spring Cloud 中文索引](https://github.com/ityouknow/awesome-spring-cloud) ⭐ 1,468 | 🐛 4 | 📅 2020-10-16
* [IT行业中文资源大全](https://github.com/ityouknow/awesome-list) ⭐ 533 | 🐛 1 | 📅 2022-10-19
